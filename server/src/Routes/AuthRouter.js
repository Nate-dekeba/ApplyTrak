...
import { login, registerUser, forgotPassword, resetPassword, verifyEmail } from '../Controllers/authController.js'

export const authRouter = express.Router()

authRouter.post('/register', registerUser)             // POST /api/auth/register
authRouter.post('/login', login)                       // POST /api/auth/login
authRouter.get('/verify-email', verifyEmail)           // GET  /api/auth/verify-email?token=xxx
